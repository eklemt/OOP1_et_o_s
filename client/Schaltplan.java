...
/**
 * Diese Klasse modelliert einen client.Schaltplan in der Welt von Elektrotechniker ohne client.Schaltplan.
 * 
 *  Ein client.Schaltplan ist dabei eine ArrayList von verschiedenen Strings, die die einzelnen Schaltteile darstellen
 *  Der client.Schaltplan kann sich zudem mit einem anderen client.Schaltplan vergleichen, um herauszufinden, ob diese übereinstimmen
 * 
...
public class Schaltplan {
   ...
   /**
    ...
    /**
     * Fuege ein Schaltteil zum client.Schaltplan hinzu
    ...
    /**
     * Funktion, um den client.Schaltplan als ArrayList zurueckzugeben
   ...
   /**
    * Funtkion um den aktuellen client.Schaltplan mit einem anderen client.Schaltplan zu vergleichen
    * @param andererSchaltplan schaltplan, der das Vergleichsobjekt ist 
    * @return boolean, ob der client.Schaltplan identisch ist oder nicht
    */
